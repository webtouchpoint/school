...
<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	<label for="name" class="col-md-4 control-label">Name:</label>
	 <div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('name', $school->name) }}" id="name" name="name">
...
<div class="form-group{{ $errors->has('address_line1') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('address_line1', $school->address_line1) }}" id="address_line1" name="address_line1">
...
<div class="form-group{{ $errors->has('address_line2') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('address_line1', $school->address_line2) }}" id="address_line2" name="address_line2">
...
<div class="form-group{{ $errors->has('dist') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('dist', $school->dist) }}" id="dist" name="dist">
...
<div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('state', $school->state) }}" id="state" name="state">
...
<div class="form-group{{ $errors->has('pin') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('pin', $school->pin) }}" id="pin" name="pin">
...
<div class="form-group{{ $errors->has('dise_code') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('dise_code', $school->dise_code) }}" id="dise_code" name="dise_code">
...
<div class="form-group{{ $errors->has('date_of_establishment') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm datepicker" value="{{ old('date_of_establishment', optional($school->date_of_establishment)->format('d-m-Y')) }}" id="date_of_establishment" name="date_of_establishment">
...
<div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('type', $school->type) }}" id="type" name="type">
...
<div class="form-group{{ $errors->has('highest_class') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input type="text" class="form-control input-sm" value="{{ old('highest_class', $school->highest_class) }}" id="highest_class" name="highest_class">
...
<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input phone="text" class="form-control input-sm" value="{{ old('phone', $school->phone) }}" id="phone" name="phone">
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input email="text" class="form-control input-sm" value="{{ old('email', $school->email) }}" id="email" name="email">
