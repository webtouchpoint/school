...
<div class="form-group{{ $errors->has('school_class_id') ? ' has-error' : '' }}">
	<label for="name" class="col-md-4 control-label">Select Class:</label>
	 <div class="col-md-6">
	    <select class="form-control input-sm" id="school_class_id" name="school_class_id" @change="onClassChange">
 ...
 <div class="form-group{{ $errors->has('subject_group_id') ? ' has-error' : '' }}" v-if="showSubjectGroup">
    ...
    <div class="col-md-6">
	    <select class="form-control input-sm" id="subject_group_id" name="subject_group_id">
